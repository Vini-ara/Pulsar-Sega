...
int main(int argc, char** argv)
{
    ...
    if(argc!=2)
    {
        printf("Uso: %s file <.bmp .mif .bin>\nConverte um arquivo .bmp com 24 bits/pixel para .mif e .bin para uso no FPGA e no Rars\n",argv[0]);
        exit(1);
    }
